...
/********************************************************************
 MINI PYTHON INTERPRETER USING C++20
            ...
            if(trimmed_line.substr(0,5)=="print") {
                ...
                if(sub.starts_with('(') && sub.ends_with(')')) {
                    ...
                    if((sub.starts_with('"') && sub.ends_with('"')) ||(sub.starts_with('\'') && sub.ends_with('\'') )) {
                        ...
                        for (int i = 0; i < variables.size() ; ++i) {
                            if (variables[i] == sub) {
                                if(types[i]=="int")
                                    ...
                                    std::cout << "[";
                                    if (arrays[std::stoi(values[i])].size() <= 2) {
                                        std::cout << "]" << std::endl;
                                    }
                                    else {
                        ...
                        /*g++ -std=gnu++20 minipython.cpp -o mp*/
                        std::cout << std::endl;
                        if(!flag){
    ...
    if(value.find("+") != -1){
        ...
        if(value.find("[") != -1 && value.find("]") != -1) {
            ...
            if(value.find(",") != -1){
                ...
                int sub_val = 0;/*std::stoi(value.substr(0,value.length()-1));*/
                /*g++ -std=gnu++20 minipython.cpp -o mp*/

                if(value.substr(value.find("[")+1) != "]") {
                    sub_val = std::stoi(value.substr(0,value.length()-1));
                }
            ...
            if(value.find("(") != -1 && value.find(")") != -1){
                ...
                std::cout << func_param << values[0] <<std::endl;
